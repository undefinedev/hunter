...
hunter_add_version(
    ...
    "4.0.0-p3"
    URL
    "https://github.com/cpp-pm/opencv/archive/v4.0.0-p3.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "4.0.0-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/v4.0.0-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "4.0.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v4.0.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.6-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.6-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.3-p4"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.3-p4.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.3-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.3-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.3-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.3-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.1-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.1-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.1-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.1-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.4.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.4.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.3.1-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.3.1-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.3.1-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.3.1-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.3.0-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.3.0-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.3.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.3.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.2.0-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.2.0-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.2.0-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.2.0-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.2.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/releases/download/v3.2.0-p0/v3.2.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.1.0-p3"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.1.0-p3.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.1.0-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.1.0-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.1.0-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.1.0-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.1.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.1.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p11"
    URL
    "https://github.com/cpp-pm/opencv/releases/download/v3.0.0-p11/v3.0.0-p11.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p10"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.0.0-p10.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p9"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.0.0-p9.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p8"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.0.0-p8.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p7"
    URL
    "https://github.com/cpp-pm/opencv/archive/v3.0.0-p7.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p6"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p6.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p5"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p5.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p4"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p4.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p3"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p3.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p1.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-rc1-p0"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-rc1-p0.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "3.0.0-beta-p2"
    URL
    "https://github.com/cpp-pm/opencv/archive/3.0.0-beta-p2.tar.gz"
    SHA1
...
hunter_add_version(
    ...
    "2.4.11-p1"
    URL
    "https://github.com/cpp-pm/opencv/archive/2.4.11-p1.tar.gz"
    SHA1
